...
} from '@features/SezioneAdminAziendale/Componenti/modali/modale-richiesta-appuntamento/modale-richiesta-appuntamento';
...
export class DashboardAziendaDisabilitata implements OnInit {
  ...
  gestisciVisibilitaModale() {
    this.modaleRichiestaAppuntamentoVisibile = !this.modaleRichiestaAppuntamentoVisibile;
  }
